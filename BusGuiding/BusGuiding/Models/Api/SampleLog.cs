...
namespace BusGuiding.Models.Api
{
    public class SampleLog : BasicRest
    {
        ...
        public static async Task<Dictionary<string, string>> AddSampleLog(string apiToken, string sampleType, DateTime deliveryTime, string extraData = "")
        {
            Dictionary<string, string> data = new Dictionary<string, string>() {
                { "sample_date", deliveryTime.ToString("yyyy-MM-dd HH:mm:ss") },
